...
CLI.start = function(script, opts, cb) {
  ...
  appConf['merge_logs'] = true;  // $$AL$$ merge by default
/*
  if (opts.mergeLogs)
...
/**
 * Launch extended API interface
 * @method web
 * @return
 */
CLI.webext = function(cb) {
  var filepath = p.resolve(p.dirname(module.filename), 'HttpInterfaceExt.js');
